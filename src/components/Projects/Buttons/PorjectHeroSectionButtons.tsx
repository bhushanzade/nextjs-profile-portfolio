...
export default function PorjectHeroSectionButtons({ project }: Props) {
  return (
    <div className="flex items-center gap-4 mt-6">
      {project?.live_or_demo_url && (
        <div className="sm:col-span-1 xl:col-span-1">
          <Button
            type="solid"
            onClick={() => window.open(project.live_or_demo_url, '_blank')}
            className="w-full"
          >
            <div className="flex items-center w-full gap-5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-10">
                <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8zm0-14a6 6 0 0 0-6 6h2a4 4 0 0 1 8 0h2a6 6 0 0 0-6-6zm-4 6a4 4 0 0 1 8 0h-8zm4 4a4 4 0 0 1-4-4h8a4 4 0 0 1-4 4z" />
              </svg>
